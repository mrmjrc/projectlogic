...
public class ImageSample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            ossClient.getObject(request, new java.io.File("example-resize.jpg"));
            ...
            ossClient.getObject(request, new java.io.File("example-crop.jpg"));
