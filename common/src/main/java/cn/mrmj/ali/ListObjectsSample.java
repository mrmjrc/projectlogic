...
/**
 * create by: mrmj
 * description: 用list从oss获取数据
 * create time: 2019/12/4 14:02
 */
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < 100; i++) {
                ...
                java.io.InputStream instream = new ByteArrayInputStream(content.getBytes());
            ...
            java.util.List<OSSObjectSummary> sums = null;
